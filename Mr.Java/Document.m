...
- (IBAction)run:(id)sender
{
    ...
    NSData *output = [[_STDOUT fileHandleForReading] readDataToEndOfFile];
    
    NSString *outputPath = [fileLoader propertyForKey:@"MAIN_DIR"];
    outputPath = [outputPath stringByAppendingPathComponent:@"_MRJ_projectoutput.txt"];
